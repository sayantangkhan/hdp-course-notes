...
\subsection{Applications of subgaussian and subexpontial random variables}
...
\end{theorem}
  ...
  This is useful to computer scientists because it allow dimension reduction.
...
\begin{proof}[Proof of Theorem \ref{thm:johnson-lindenstrauss}]
  ...
  \begin{align*}
    \left| \norm{Gv}_2 - n \right| \leq \varepsilon
  \end{align*}
