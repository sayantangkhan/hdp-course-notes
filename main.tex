...
\begin{proof}[Proof of Theorem \ref{thm:maurey}]
  ...
  \end{align*}
  {\color{red} \confused{  It is unclear how Rudelson goes from the first to second line in the above chain of equalities: this is possibly a mistake}} Using the fact that $f$ is $1$-Lipschitz, and $\sigma$ is a transposition, we see that $f(\pi)$ and $f(\pi \circ \sigma)$ differ by at most $2$.
